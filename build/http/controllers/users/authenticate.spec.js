...
app.setErrorHandler((error, _, reply) => {
  if (error instanceof import_zod3.ZodError) {
    return reply.status(import_http_status2.default.BAD_REQUEST).send({ message: "Validation error.", issues: error.format() });
  }
...
(0, import_vitest.describe)("Authenticate (e2e)", () => {
  ...
  (0, import_vitest.it)("should be able to authenticate", async () => {
    ...
    (0, import_vitest.expect)(response.status).toEqual(200);
